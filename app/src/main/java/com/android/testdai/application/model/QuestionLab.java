...
import com.android.testdai.application.db.local.cursors.AnswerCursorWrapper;
import com.android.testdai.application.model.Question.Answer;
import com.android.testdai.util.BaseHelper;
...
public class QuestionLab extends ArrayList<Parcelable> {
    ...
    private Cursor queryImageSource() {
        Cursor cursor = mDatabase.query(
                DbSchema.QuestionTable.NAME,
                new String[]{DbSchema.QuestionTable.Cols.IMAGESOURCE},
                DbSchema.QuestionTable.Cols.IMAGESOURCE + " != ?",
                new String[]{""},
                null,
                null,
                null
    ...
    public List<Question> getQuestions(String category) {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            QuestionCursorWrapper cursor = queryQuestion(DbSchema.QuestionTable.Cols.ID + "=?", new String[]{questionsNumber});
            try {
                cursor.moveToFirst();
    ...
    private int randomQuestion(int questionNumber, String category) {
    ...
    private List<Integer> listTopic(int questionNumber, String category) {
